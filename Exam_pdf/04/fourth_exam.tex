...
\usepackage{amsmath} %\normal miatt
\usepackage{endnotes} % endnotes miatt
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\par
...
While editing a document, you may find that you need to typeset something as a footnote \footnote{...like this one...} or as a "margin-note" \marginnote{as this one} or even as a note at the end of as this your document \endnote{Now, this is a note at the end of the document.} For the latter one you will need to use a package. \par
